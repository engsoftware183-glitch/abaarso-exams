...
-- CreateEnum
CREATE TYPE "ResultStatus" AS ENUM ('DRAFT', 'PENDING', 'PUBLISHED', 'ARCHIVED');
...
CREATE TABLE "Result" (
    ...
    "courseId" TEXT NOT NULL,
    "semesterId" TEXT NOT NULL,
    "attendanceMarks" DOUBLE PRECISION NOT NULL,
    "attendancePercentage" DOUBLE PRECISION NOT NULL,
    "assessmentMarks" DOUBLE PRECISION NOT NULL,
    "midtermMarks" DOUBLE PRECISION NOT NULL,
